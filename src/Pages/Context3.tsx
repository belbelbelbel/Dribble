export const Context3 = () => {
    return (
        <div className='w-screen md:h-[40vw] flex-col h-[70vw]  flex justify-center items-center  '  >
            ...
            <div className='z-40 relative items-center justify-center flex-col gap-[3vw] flex w-[80%] mx-auto'>
                <div className='text-center  flex-col flex gap-[0.8vw]'>
                    <h1 className='font-bold text-black text-[2vw]'>Products</h1>
                ...
                <div className='flex gap-[2vw] items-center '>
                    <div className='h-[21vw] w-[25vw] pink-b rounded-[1vw]'>
                    ...
                    <div className='h-[21vw] w-[25vw]  rounded-[1vw]'>
                        <div className=' flex flex-col gap-[0.5vw] w-[25vw] h-[13vw] items-center rounded-[2vw]'>
