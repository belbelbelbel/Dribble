...
export const Header = () => {
    return (
        <div className='w-screen  text-black z-20'>
            <div className='w-screen 2xl:h-[35vw] md:h-[35vw] xl:h-[40vw] h-[50vw]  pink-bg overflow-hidden  flex flex-col justify-center items-center '>
                ...
                <div className="">
                    <img src="/wave (10).svg" alt="wavy flow" className='absolute 2xl:-bottom-[5.5vw] xl:-bottom-[4vw] -rotate-270  z-0 left-0  ' />
                </div>
            </div>
