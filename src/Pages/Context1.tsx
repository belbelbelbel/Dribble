...
export const Content1 = () => {
  return (
    <div className='relative w-screen h-[60vw]  mx-auto items-center justfiy-center flex '>
      <div className='w-[80%] mx-auto flex items-center gap-[4vw] flex-col'>
        <div className='text-center flex-col flex gap-[0.8vw]'>
          ...
          <div className='text-[0.7vw] text-gray-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod porro dolores nihil minus aperiam, eum quam, earum expedita,<br /> aspernatur suscipit ex? Atque, nesciunt vel quibusdam reprehenderit animi pariatur temporibus debitis?</div>
        </div>
