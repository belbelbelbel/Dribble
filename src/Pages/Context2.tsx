...
export const Content2 = () => {
    return (
        <div className='w-screen h-[40vw] pink-bgg  '  >
            ...
            <div className='z-40 relative items-center justify-center -top-[30vw]  flex-col gap-[3vw] flex w-[80%] mx-auto'>
                <div className='text-center  flex-col flex gap-[0.8vw]'>
                    <h1 className='font-bold text-black text-[2vw]'>Events</h1>
